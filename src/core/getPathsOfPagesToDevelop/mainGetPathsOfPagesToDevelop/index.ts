...
export default function () {
	...
	function composePaths( info: any ): string[] {
		...
		*/
		function composePathsByNormalKeyword( info: any, pathNames: string[] = [] ): string[] {
			let paths: string[] = []

			recur( info )

			function recur( plainObject: i.SelectionElement, pathNames: string[] = [] ) {
